...
_USERINFORESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='avatar', full_name='user.UserInfoResponse.avatar', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FINDUSERBYEMAILREQUEST = _descriptor.Descriptor(
  ...
  full_name='user.FindUserByEmailRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='email_hash', full_name='user.FindUserByEmailRequest.email_hash', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FINDUSERBYEMAILRESPONSE = _descriptor.Descriptor(
  ...
  full_name='user.FindUserByEmailResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='lst_user', full_name='user.FindUserByEmailResponse.lst_user', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WORKSPACEUPDATEDISPLAYNAMEREQUEST = _descriptor.Descriptor(
  name='WorkspaceUpdateDisplayNameRequest',
  full_name='user.WorkspaceUpdateDisplayNameRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='user_id', full_name='user.WorkspaceUpdateDisplayNameRequest.user_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='display_name', full_name='user.WorkspaceUpdateDisplayNameRequest.display_name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FINDUSERBYEMAILRESPONSE.fields_by_name['lst_user'].message_type = _USERINFORESPONSE
...
DESCRIPTOR.message_types_by_name['WorkspaceUpdateDisplayNameRequest'] = _WORKSPACEUPDATEDISPLAYNAMEREQUEST
...
_USER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='user.User.find_user_by_email',
    index=11,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='find_user_detail_info_from_email_hash',
    full_name='user.User.find_user_detail_info_from_email_hash',
    index=12,
    containing_service=None,
    input_type=_FINDUSERBYEMAILREQUEST,
    output_type=_USERINFORESPONSE,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='user.User.workspace_update_display_name',
    index=20,
    containing_service=None,
    input_type=_WORKSPACEUPDATEDISPLAYNAMEREQUEST,
    output_type=_BASERESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
