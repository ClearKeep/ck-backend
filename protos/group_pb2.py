...
_WORKSPACEMEMBERFORGOTPASSWORDINGROUP = _descriptor.Descriptor(
  name='WorkspaceMemberForgotPasswordInGroup',
  full_name='group.WorkspaceMemberForgotPasswordInGroup',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='user_id', full_name='group.WorkspaceMemberForgotPasswordInGroup.user_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WORKSPACEMEMBERRESETPINCODEINGROUP = _descriptor.Descriptor(
  name='WorkspaceMemberResetPincodeInGroup',
  full_name='group.WorkspaceMemberResetPincodeInGroup',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='user_id', full_name='group.WorkspaceMemberResetPincodeInGroup.user_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['WorkspaceMemberForgotPasswordInGroup'] = _WORKSPACEMEMBERFORGOTPASSWORDINGROUP
DESCRIPTOR.message_types_by_name['WorkspaceMemberResetPincodeInGroup'] = _WORKSPACEMEMBERRESETPINCODEINGROUP
...
_GROUP = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='group.Group.workspace_member_forgot_password_in_group',
    index=11,
    containing_service=None,
    input_type=_WORKSPACEMEMBERFORGOTPASSWORDINGROUP,
    output_type=_BASERESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    full_name='group.Group.workspace_member_reset_pincode_in_group',
    index=12,
    containing_service=None,
    input_type=_WORKSPACEMEMBERRESETPINCODEINGROUP,
    output_type=_BASERESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
