...
_WORKSPACENOTIFYDEACTIVEMEMBER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='deactive_account', full_name='group.WorkspaceNotifyDeactiveMember.deactive_account', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='group_id', full_name='group.WorkspaceNotifyDeactiveMember.group_id', index=1,
      number=2, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WORKSPACENOTIFYDEACTIVEMEMBER.fields_by_name['deactive_account'].message_type = _MEMBERINFO
