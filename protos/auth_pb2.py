...
_AUTH = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='veriry_pincode',
    full_name='auth.Auth.veriry_pincode',
    index=10,
    containing_service=None,
