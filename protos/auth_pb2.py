...
_UPDATEPINCODEREQ = _descriptor.Descriptor(
  name='UpdatePinCodeReq',
  full_name='auth.UpdatePinCodeReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='hash_pincode', full_name='auth.UpdatePinCodeReq.hash_pincode', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='salt', full_name='auth.UpdatePinCodeReq.salt', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='IvParameterSpec', full_name='auth.UpdatePinCodeReq.IvParameterSpec', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='client_key_peer', full_name='auth.UpdatePinCodeReq.client_key_peer', index=3,
...
_UPDATEPINCODEREQ.fields_by_name['client_key_peer'].message_type = _PEERREGISTERCLIENTKEYREQUEST
...
DESCRIPTOR.message_types_by_name['UpdatePinCodeReq'] = _UPDATEPINCODEREQ
...
UpdatePinCodeReq = _reflection.GeneratedProtocolMessageType('UpdatePinCodeReq', (_message.Message,), {
  'DESCRIPTOR' : _UPDATEPINCODEREQ,
  '__module__' : 'protos.auth_pb2'
  # @@protoc_insertion_point(class_scope:auth.UpdatePinCodeReq)
  })
_sym_db.RegisterMessage(UpdatePinCodeReq)
...
_AUTH = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='update_pincode',
    full_name='auth.Auth.update_pincode',
    index=11,
    containing_service=None,
    input_type=_UPDATEPINCODEREQ,
    output_type=_BASERESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
